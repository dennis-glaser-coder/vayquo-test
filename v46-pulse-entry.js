...
function mount(){let box=document.querySelector('.v46-pulse-home');if(!startActive()){box?.remove();return;}if(box)return;const ratgeber=document.querySelector('.v24-ratgeber-home');const advisor=document.querySelector('#v28-card-advisor-entry');const anchor=ratgeber||advisor;if(!anchor||!anchor.parentElement)return;ensureStyle();box=document.createElement('a');box.className='v46-pulse-home';box.href='/pulse.html';box.setAttribute('aria-label','VAYQUO PULSE öffnen');box.innerHTML='<div class="v46-pulse-kicker">VAYQUO PULSE</div><h3>Behält deine Kreditkarte für dich im Blick.</h3><p>Ändern sich Gebühren oder geprüfte Vorteile, zeigt dir VAYQUO, was sich geändert hat und ob du deine Karte neu prüfen solltest.</p><div class="v46-pulse-cta"><span>Karte beobachten</span><b aria-hidden="true">→</b></div>';anchor.insertAdjacentElement('afterend',box);}
