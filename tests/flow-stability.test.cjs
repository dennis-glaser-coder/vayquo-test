...
// 3-second clarity checks on the three central user areas.
...
assert(points.includes('Diese Stände nutzt VAYQUO für deine Auswertungen.'), 'points page must explain why balances matter');
