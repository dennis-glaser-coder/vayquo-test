...
assert(homeUsp.includes('v44-home-visual-trust.js?v=4410'),'existing home USP module must load the current isolated visual module');
...
assert(moduleSource.includes('FÜR DICH JETZT'),'existing personalized optimizer must be introduced as the next home section');
...
console.log('VAYQUO home visual gates: OK (clear home hierarchy; real wallet hero; compatibility node preserved; card-check flow preserved)');
