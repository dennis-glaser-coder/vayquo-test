...
for(const url of ['https://vayquo.de/photovoltaik/','https://vayquo.de/photovoltaik/kosten.html','https://vayquo.de/photovoltaik/paderborn.html','https://vayquo.de/partner.html']) assert(sitemap.includes(url),`sitemap missing ${url}`);
